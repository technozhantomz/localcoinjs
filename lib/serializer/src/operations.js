...
export const activenode_create_operation_fee_parameters = new Serializer(
    "activenode_create_operation_fee_parameters",
    {fee: uint64}
);
...
export const activenode_create_operation = new Serializer(
    "activenode_create_operation",
    {fee: asset,
    activenode_account: protocol_id_type("account")}
);

export const activenode_send_activity = new Serializer(
    "activenode_send_activity",
    {
        fee: asset,
        activenode_account: protocol_id_type("account")
    }
...
export const empty_type_one_operation = new Serializer(
    "empty_type_one_operation",
    {fee: asset,
    activenode_account: protocol_id_type("account")}
);

export const empty_type_two_operation = new Serializer(
    "empty_type_two_operation",
    {fee: asset,
    activenode_account: protocol_id_type("account")}
);
export const empty_type_three_operation = new Serializer(
    "empty_type_three_operation",
    {fee: asset,
    activenode_account: protocol_id_type("account")}
);  
